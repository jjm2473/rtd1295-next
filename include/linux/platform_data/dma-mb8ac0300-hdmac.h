...
extern void hdmac_set_skip_termin_and_initial(u32 chans, u32 on_off);
extern int hdmac_set_chan_dmac(u32 channel, struct hdmac_req *_hdmac_req, u32 set);

/*
 * Register dma requesting device
 */
extern int hdmac_register_dma_req_dev(u32 chip_index, struct device *dev);

/*
 * Unregister dma requesting device
 */
extern int hdmac_unregister_dma_req_dev(u32 chip_index, struct device *dev);
