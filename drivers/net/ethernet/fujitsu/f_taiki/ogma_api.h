...
typedef struct ogma_normal_mode_hwconf_s {
    ogma_uint use_jumbo_pkt_flag:1;
    ogma_uint tx_little_endian_flag:1;
    ogma_uint rx_little_endian_flag:1;
    ogma_uint tx_tmr_mode_flag:1;
    ogma_uint rx_tmr_mode_flag:1;
    ogma_pkt_ctrl_param_t pkt_ctrl_param;
} ogma_normal_mode_hwconf_t;
