...
#include <platform/fujitsu_mb86s70/mali_kbase_config_fujitsu_mb86s70.h>
 ...
 */
#if defined(CONFIG_MALI_ARID_16)
#define DEFAULT_ARID_LIMIT KBASE_AID_16
#elif defined(CONFIG_MALI_ARID_8)
#define DEFAULT_ARID_LIMIT KBASE_AID_8
#elif defined(CONFIG_MALI_ARID_4)
#define DEFAULT_ARID_LIMIT KBASE_AID_4
#else /* CONFIG_MALI_ARID_32 */
 ...
 * may limit to a lower value.
 */
#if defined(CONFIG_MALI_AWID_16)
#define DEFAULT_AWID_LIMIT KBASE_AID_16
#elif defined(CONFIG_MALI_AWID_8)
#define DEFAULT_AWID_LIMIT KBASE_AID_8
#elif defined(CONFIG_MALI_AWID_4)
#define DEFAULT_AWID_LIMIT KBASE_AID_4
#else /* CONFIG_MALI_AWID_32 */
