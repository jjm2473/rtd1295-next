...
static struct reg_default adau1761_reg_defaults[] = {
	...
	{ ADAU1761_PLAY_HP_LEFT_VOL,		0x02 },
	{ ADAU1761_PLAY_HP_RIGHT_VOL,		0x02 },
	{ ADAU1761_PLAY_LINE_LEFT_VOL,		0x02 },
	{ ADAU1761_PLAY_LINE_RIGHT_VOL,		0x02 },
	{ ADAU1761_PLAY_MONO_OUTPUT_VOL,	0x00 },
	{ ADAU1761_POP_CLICK_SUPPRESS,		0x00 },
	{ ADAU1761_JACK_DETECT_PIN,		0x08 },
...
static const struct snd_kcontrol_new adau1761_single_mode_controls[] = {
	...
	SOC_SINGLE_TLV("Input 4 Capture Volume", ADAU1761_REC_MIXER_RIGHT0,
		1, 7, 0, adau1761_sing_in_tlv),
 	/* Jerry: Add kcontrol for single-ended microphone input */
        SOC_DOUBLE_R_TLV("Capture Volume", ADAU1761_LEFT_DIFF_INPUT_VOL,
              ADAU1761_RIGHT_DIFF_INPUT_VOL, 2, 0x3f, 0, adau1761_diff_in_tlv),
        SOC_DOUBLE_R("Capture Switch", ADAU1761_LEFT_DIFF_INPUT_VOL,
                ADAU1761_RIGHT_DIFF_INPUT_VOL, 1, 1, 0),
...
static const struct snd_kcontrol_new adau1761_right_mixer_controls[] = {
	...
	SOC_DAPM_SINGLE("Right DAC Switch", ADAU1761_PLAY_MIXER_RIGHT0,
								6, 1, 0),
	SOC_DAPM_SINGLE_TLV("Aux Bypass Volume",
				 ...
				 enum snd_soc_bias_level level)
{
	...
	case SND_SOC_BIAS_ON:
		/* Jerry: Enable the MICBIAS output */
                adau17x1_set_micbias_voltage(codec, ADAU17X1_MICBIAS_0_90_AVDD);
		break;
...
static int adau1761_setup_headphone_mode(struct snd_soc_codec *codec)
{
	...
	case ADAU1761_OUTPUT_MODE_HEADPHONE_CAPLESS:
		regmap_update_bits(adau->regmap,
					ADAU1761_PLAY_MONO_OUTPUT_VOL, 3, 3);
	case ADAU1761_OUTPUT_MODE_HEADPHONE: /* fallthrough */
		regmap_update_bits(adau->regmap,
					ADAU1761_PLAY_HP_RIGHT_VOL, 1, 1);
		break;
	default:
		return -EINVAL;
	}
...
static int adau1761_probe(struct snd_soc_codec *codec)
{
	...
	case ADAU1761_OUTPUT_MODE_HEADPHONE:
		regmap_update_bits(adau->regmap,
					ADAU1761_PLAY_LINE_LEFT_VOL, 1, 1);
		regmap_update_bits(adau->regmap,
					ADAU1761_PLAY_LINE_RIGHT_VOL, 1, 1);
		break;
	default:
		return -EINVAL;
	}
...
{
	enum adau17x1_type type = ADAU1361;
	struct snd_soc_dai_driver *dai_drv;
	struct regmap *regmap;
	int ret;
...
static const struct of_device_id adau1x61_dt_ids[] = {
...
static struct i2c_driver adau1761_i2c_driver = {
	.driver = {
		.name = "adau1x61",
		.owner = THIS_MODULE,
		.of_match_table = adau1x61_dt_ids,
	},
